...
<body>
    ...
    <main>
        <div class="principal">
            ...
            $sql = "SELECT * FROM vw_feedProf WHERE nomeServico = '$servico'";
        ...
        ?>
                <div  class="card_perfil ">
                    <div class="img-perfil">
                        <img class="img-profile" src="upload/<?php echo $fotoPerfil[$i]; ?>">
                    </div>
                    <div class="informacoes">
                        <h2 class="username"><?php echo $nome[$i]; ?><?php echo $sobrenome[$i]; ?></h2>
                        <div class="row">
                            <div class="descricao">
                                <p class="profile-desc"><?php echo $descricao[$i]; ?> </p>
                            </div>
                            <ul class="avaliacao">
                    ...
                    <button onclick="document.location='FeedUsuario.php'servico=<?php echo $idProfissional[$i]; ?>" class="btn-perfil">Ver perfil</button>
                </div>
                <?php
                     $i++;
                }
