                ...
                <ul>
                    ...
                    <div class="dropdown-content-prof">
                        <ul>
                            ...
                            <li class="sair" href="sair.php"><span class="material-symbols-outlined">
                                    logout
                                </span>Sair</li>
                        </ul>
                    </div>
    ...
    <main>
        ...
        ?>
              ...
              <div class="feed">
                ...
                <?php      $sql = "SELECT * FROM vw_publicacoes WHERE email = '$email'";
            ...
            if($resultado=mysqli_query ($conexao, $sql)){
                ...
                while ($registro=mysqli_fetch_assoc($resultado)) {
                    ...
                    $curtidas[$i] = $registro['curtidas'];
                    $imagem[$i] = $registro['imagem'];
                    $descricao[$i] = $registro['descricao'];
                    
                    $data_americana =  $data[$i];
        ...
        ?>
                    <div class="card_perfil">
                        ...
                        <div class="img-perfil">
                            <img class="img-profile" src="upload/<?php echo $imagem[$i]; ?>">
                        </div>
                        <div class="legenda">
                            <p class="legenda"><?php echo $descricao[$i]; ?></p>
                            <div class="data_like">
                                <p class="data"><?php echo date("d/m/Y", strtotime($data_americana)); ?></p>
            ...
            $sql = "SELECT * FROM vw_avaliacoes WHERE email = '$email'";
            ...
            if($resultado=mysqli_query ($conexao, $sql)){
                ...
                while ($registro=mysqli_fetch_assoc($resultado)) {
                    ...
                    $sobrenome[$i] = $registro['sobrenome'];
                    $fotoPerfil[$i] = $registro['fotoPerfil'];
                    $comentario[$i] = $registro['comentario'];
                    $dataAval[$i] = $registro['dataAval'];
                    
                    $data_americana =  $dataAval[$i];
        ?>
                    <div class="card-av">
             ...
             <div class="av-header">
                            <div class="header-img">
                                <img src="upload/<?php echo $fotoPerfil[$i]; ?>" class="image-header">
                            </div>
                            <div class="header-info">
                               <h4><?php echo $nome[$i]; ?>, <?php echo $sobrenome[$i]; ?></h4>
                                <p><?php echo date("d/m/Y", strtotime($data_americana)); ?></p>
                            </div>
                            <div class="aspas">
                                <span class="material-symbols-outlined">
                                    format_quote
